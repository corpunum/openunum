export async function handleConfigRoute({ req, res, url, ctx }) {
  ...
  if (req.method === 'POST' && url.pathname === '/api/providers/config') {
    ...
    if (typeof up.xiaomimimoAnthropicBaseUrl === 'string') ctx.config.model.xiaomimimoAnthropicBaseUrl = up.xiaomimimoAnthropicBaseUrl.trim();
  ...
  if (req.method === 'POST' && url.pathname === '/api/providers/import-openclaw') {
    ...
    if (imported.xiaomimimoAnthropicBaseUrl) ctx.config.model.xiaomimimoAnthropicBaseUrl = imported.xiaomimimoAnthropicBaseUrl;
    ...
    ctx.sendJson(res, 200, {
      ...
      imported: {
        ...
        xiaomimimoAnthropicBaseUrl: imported.xiaomimimoAnthropicBaseUrl || ctx.config.model.xiaomimimoAnthropicBaseUrl,
