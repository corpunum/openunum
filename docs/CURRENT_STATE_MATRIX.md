...
| CI baseline gates | `.github/workflows/phase-gates.yml` | Expanded (unit, smoke, UI smoke, imitation, core e2e + phase39/40/41/42/43/44/45/46, phase0 gates, runtime-surface gate, route-wiring gate, ui-surface gate) |
